...
/*   Updated: 2024/09/23 12:18:59 by pnsaka           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		Bureaucrat::executeForm(AForm const &form){
	if(this->getGrade() > form.getGradeToExecute() || this->getGrade() > form.getGradeToSign()){
		if(this->getGrade() > form.getGradeToExecute())
			std::cerr << "Grade too low to execute form" << std::endl;
		if(this->getGrade() > form.getGradeToSign())
			std::cerr << "Grade too low to sign form" << std::endl;
		throw Bureaucrat::GradeTooLowException();
	} else {
		form.execute(*this);
